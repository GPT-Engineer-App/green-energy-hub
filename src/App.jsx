...
import SolarPanelCalculator from "./pages/DesignTools/SolarPanelCalculator.jsx"; // Updated import
        ...
        <Router>
          <Routes>
            <Route path="/" element={<Layout />}>
              ...
              <Route path="/design-tools/solar-panel-calculator" element={<SolarPanelCalculator />} /> {/* New route */}
            </Route>
          </Routes>
        </Router>
      </TooltipProvider>
