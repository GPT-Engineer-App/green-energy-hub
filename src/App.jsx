...
import SolarPanelCalculator from "./pages/SolarPanelCalculator.jsx"; // Import SolarPanelCalculator
        ...
        <Router>
          <Routes>
            <Route path="/" element={<Layout />}>
              ...
              <Route path="/design-tools/solar-panel-calculator" element={<SolarPanelCalculator />} /> {/* Move SolarPanelCalculator under Design Tools */}
